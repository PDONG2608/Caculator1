...
class MainActivity : AppCompatActivity(), View.OnClickListener {
                    ...
                    if (operator) {
                        when (status) {
                            ...
                            "division" -> {
                                ...
                                firstNumber =
                                    java.lang.Double.parseDouble(binding.textViewResult.text.toString())
                            }
                        }
                    }
    ...
    @SuppressLint("SetTextI18n")
    private fun plus() {
        lastNumber = java.lang.Double.parseDouble(binding.textViewResult.text.toString())
    ...
    private fun minus() {
        if (firstNumber == 0.0) {
            firstNumber = java.lang.Double.parseDouble(binding.textViewResult.text.toString())
        } else {
            lastNumber = java.lang.Double.parseDouble(binding.textViewResult.text.toString())
            firstNumber -= lastNumber
        }
